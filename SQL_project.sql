...
city that has the highest sum of invoice totals. Return both the city name and sum of
all invoice totals. */
...
be declared the best customer. write a query that returns the person who has spent
the most money. */
...
write a query that returns the artist name and the total track count of the top
10 rock bands. */
